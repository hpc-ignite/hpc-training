...
## **🔹 บทนำ**
LANTA ใช้ระบบ **Slurm** ในการจัดการคิวงาน (Job Scheduling) ดังนั้นก่อนที่จะสามารถรันงานได้ นักเรียนจำเป็นต้องเข้าใจ **ขั้นตอนการส่งงาน (Job Submission)** และ **คำสั่งที่สำคัญของ Slurm**.เราเตรียมไฟล์ต่าง ๆ ไว้ในโฟลเดอร์ของโปรเจ็กต์ ดังนั้นในขั้นตอนแรกเราจะคัดลอกไฟล์สำหรับฝึกซ้อมจาก Project folder มาที่ Home Folder ของเรา
